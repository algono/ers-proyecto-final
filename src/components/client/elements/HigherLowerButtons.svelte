<script lang="ts">
  ...
  export let guess: (direction: 'higher' | 'lower') => void;
</script>
...
<style>
  ...
  button {
    ...
    cursor: pointer;
    font-weight: bold;
    transition: all 0.2s ease-in-out; /* Transición suave para colores y sombras */
  ...
  .up:hover { 
    ...
    transform: translateY(-2px); /* Se levanta un poquito, efecto premium */
  }
